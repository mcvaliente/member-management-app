...
contract Member {
    ...
    function addMemberLocation(bytes32 memberId, string memory county, string memory office, string memory country) public existing(memberId) restricted (msg.sender) {
